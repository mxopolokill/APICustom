 ...
 */
class getScoresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ScoresRepository' shared autowired service.
     *
     * @return \App\Repository\ScoresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ScoresRepository.php';

        return $container->privates['App\\Repository\\ScoresRepository'] = new \App\Repository\ScoresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
